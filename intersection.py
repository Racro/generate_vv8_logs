...
log_files = [f for f in os.listdir('./template_crawler/vv8_logs/control/') if f.endswith('.processed')]
# print(log_files)
master = {}
count = 0
...
json.dump(intersection_dict, open('./template_crawler/vv8_logs/control/intersection.json', 'w'), cls=SetEncoder)
